...
const directTransferUploadData = ref<Record<string, unknown> | null>(null)
...
.torrents-view :deep(.el-table__header-wrapper),
.torrents-view :deep(.el-table__body-wrapper) {
  overflow-x: auto;
}
...
:deep(.cross-seed-card.el-card) {
  background-color: #ffffff !important;
  backdrop-filter: none !important;
  -webkit-backdrop-filter: none !important;
}

:deep(.cross-seed-card .el-card__header) {
  background-color: #ffffff !important;
