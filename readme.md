...
> **注：如果是 v3.1.1 之前的版本无法更新则重新拉取镜像即可增加 gitee 仓库就行更新。**
...
> **注：如果是 v3.1.1 之前的版本无法更新则重新拉取镜像即可切换成使用 gitee 仓库更新。**
...
- 修改：使用 gitee 233 仓库进行热更新（如果是 v3.1.1 之前的版本无法更新则重新拉取镜像即可切换成使用 gitee 仓库更新）
